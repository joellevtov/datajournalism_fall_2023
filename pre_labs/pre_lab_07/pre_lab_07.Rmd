...
```{r echo=FALSE}
## census_api_key("8ca27fc51762196a5aeff26a30f55f031661f2c0", install=TRUE)
```
...
**Task** What is another question you could ask of this data? **Which county has the lowest high school graduation to college rate, and in that county (I assume Prince George's given that Bladensburg High has only 18%), do we see the same weath gaps that predict education outcomes? **
