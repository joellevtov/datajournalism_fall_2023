...
##(col_name, 'what_you_want_to_replace', 'what_you_want_to_replace_it_with')
## "//." not "." because "." means any character at all so it would replace all characters with nothing
