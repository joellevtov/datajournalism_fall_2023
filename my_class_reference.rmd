...
`right_join` - takes the table on the right and adds only matching data from the left table
...
-   ggplot - makes the map

-   tigris - has state, county, and local borders taken directly from the Census
